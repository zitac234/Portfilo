...
export default class about extends React.Component{
      ...
      skills(){
            return (
                  <div id='right' className='split'>
                         <img className='logo'  id='gitLogo' src='/image/gitLogo.png'/>
                        <img className='logo'  id='cssLogo' src='/image/CSSlogo.png'/>              
                        <img className='logo'  id='chaiLogo' src='/image/chaiLogo.png'/>
                        ...
                        <img className='logo'  id='mochaLogo' src='/image/mochaLogo.png'/>
      ...
      story(){
            return (
                  <div id = 'divStory' >
                        <p> 
                              Growing up in Nigeria, I love solving the riddles in my grandfather old newspapers. Sometimes, it can take a few days or even a week to solve yet I persist. I will try to  rememeber solutions to old riddles or ask people indirect questions inother to solve it.  
            ...
            return(
                  <div >
                        ...
                        <div id= 'left' className='split'>
                              <img id='img' src='public/image/image.jpeg'/>
                              {this.story()}
                        </div>
                        {this.skills()}
                  </div>
