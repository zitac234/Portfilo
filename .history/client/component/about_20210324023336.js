...
export default class about extends React.Component{
      ...
      skills(){
            return (
                  <div id='divSkills'>
                        <img className='logo' id='rubyLogo' src='public/image/rubyLogo.png'/>
                        <img className='logo'  id='cssLogo' src='public/image/CSSlogo.png'/>
                        <img className='logo'  id='htmlLogo' src='public/image/htmlLogo.png'/>
                        <img className='logo'  id= 'reduxLogo'  src='public/image/Redux.png' />
                        <img className='logo'  id='nodeLogo' src='public/image/nodejsLogo.png'/>
                        <img className='logo'  id='reactLogo' src='public/image/ReactLogo.png'/>
                        <img className='logo'  id='expressLogo' src='public/image/expressLogo.png'/>
                        <img className='logo'  id='javascriptLogo' src='public/image/JavaScript-logo.png'/>
                  </div>
            )
      }
      story(){
