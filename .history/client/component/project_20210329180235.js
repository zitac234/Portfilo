      ...
      graceshopper(){
            return (
                  ...
                  <div className='divLeft'>
                        <h4 className='projectsHeader'>Description</h4>
                        <p>
                        An e-commerce site in which guests and logged-in users alike can browse, and purchase wedding dresses. Userscan manage their accounts and admins can make edits to the website functionality.. 
                        </p>
                        <h4 className='projectsHeader'>Tech stacks</h4>
                              <ul>
                                    <li>Javascript</li>
